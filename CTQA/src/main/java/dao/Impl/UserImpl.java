    ...
    public List<User1> getListUser1(String tenTaiKhoan) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                String passWord = rs.getString("tenNhanVien");
                String address = rs.getString("matKhau");
                String birthday = rs.getString("tenTaiKhoan");
                String sex = rs.getString("tenNhanVien");
